...
class UnderPerformersPage extends StatefulWidget {
  const UnderPerformersPage({super.key});

  @override
  UnderPerformersPageState createState() => UnderPerformersPageState();
}

class UnderPerformersPageState extends State<UnderPerformersPage> {
  @override
      ...
      body: Container(
        decoration: const BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage("assets/Anthonyremovebgpreview1.png"),
            fit: BoxFit.fill,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: const EdgeInsets.only(top: 20),
                    child: Text(
                      "5 most under-performing ${position} are",
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image : const DecorationImage(
                                    image: AssetImage('assets/Player_profremovebgpreview1.png'),
                                    fit: BoxFit.fitWidth
                                ),
                              )
                          )
